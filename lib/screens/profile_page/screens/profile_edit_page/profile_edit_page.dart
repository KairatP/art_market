...
//                   ),
//                   onPressed: () {
//                     if (productBloc.state.images?.path.isEmpty ?? true &&
...
//                       children: [
//                         state.images?.path.isEmpty ?? true
//                             ? Container(
                  ...
                  onPressed: () {
                    if (productBloc.state.images!.path.isEmpty &&
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) => CupertinoAlertDialog(
                          title: const Text('Error'),
                          content: const Text('Please enter all required information, including picture'),
                          actions: [
                            CupertinoDialogAction(
                              isDefaultAction: true,
                              onPressed: () => {Navigator.pop(context)},
                      ...
                      DropdownSearch<String>(
                        ...
                        dropdownDecoratorProps: DropDownDecoratorProps(
                          ...
                          dropdownSearchDecoration: InputDecoration(
                            prefixIcon: const Icon(Icons.public),
                            hintStyle: AppTextStyle.blackBodyTextStyle,
