...
class RegConfirmScreen extends StatelessWidget {
  RegConfirmScreen({
    Key? key,
    required this.sate,
    required this.bloc,
  ...
  return Column(
      ...
      children: [
        ...
        BrButton(
          ...
          onPressed: () {
             bloc.add(RegTougleEvent(
                mainAuthTougle: true, registartionScreen: true, forgotScreen: sate.forgotScreen, loginScreen: true, forgotPasswordConfirmScreen: sate.forgotPasswordConfirmScreen, passwordUpdateScreen: sate.passwordUpdateScreen));
          },
        ...
        onPressed: () {
          bloc.add(RegTougleEvent(
             mainAuthTougle: sate.mainTougleState, registartionScreen: true, loginScreen: sate.loginScreen, forgotScreen: sate.forgotScreen, forgotPasswordConfirmScreen: sate.forgotPasswordConfirmScreen, passwordUpdateScreen: sate.passwordUpdateScreen));
