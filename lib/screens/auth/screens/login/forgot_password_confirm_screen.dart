...
class ForgotPswConfirmScreen extends StatefulWidget {
  const ForgotPswConfirmScreen({
    Key? key,
    required this.sate,
    required this.bloc,
  }) : super(key: key);
  ...
  @override
  State<ForgotPswConfirmScreen> createState() => _ForgotPswConfirmScreenState();
}

class _ForgotPswConfirmScreenState extends State<ForgotPswConfirmScreen> {
  ...
  return Form(
    ...
    child: Column(
        ...
        children: [
            ...
            onPressed: () {
              if (_formKey.currentState!.validate())  {
                 widget.bloc.add(RegTougleEvent(
                  ...
                  forgotPasswordConfirmScreen: false, 
                  passwordUpdateScreen: true));
            } else {
              return;
            }
              },
          ...
          onPressed: () {
            widget.bloc.add(RegTougleEvent(
                  mainAuthTougle: widget.sate.mainTougleState, registartionScreen: widget.sate.registartionScreen, forgotScreen: true, loginScreen: widget.sate.loginScreen, forgotPasswordConfirmScreen: false, passwordUpdateScreen: widget.sate.passwordUpdateScreen));
          },
        ),
        const Spacer(
                flex: 3,
