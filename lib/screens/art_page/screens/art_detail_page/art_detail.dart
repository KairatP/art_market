    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ...
            widget.artModelType.urls.length == 1 || widget.artModelType.urls.isEmpty
                ? const SizedBox()
                : Padding(
                    // Positioner part
            ...
            //       widget.artModelType.urls.length,
            //       (index) => Padding(
            //         padding: const EdgeInsets.symmetric(horizontal: 4.0),
            //         child: Text(
            //           (index + 1).toString(),
            //           style: TextStyle(
            //             color: index == _count ? AppColors.mainColor : Colors.grey,
            //             fontSize: 16.0,
            //             fontWeight: index == _count ? FontWeight.bold : FontWeight.normal,
            //           ),
            //         ),
            //       ),
            //     ),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: widget.artModelType.author.avaUrl
                                              .isEmpty
                                          ? const NetworkImage(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          widget
                                              .artModelType.author.phoneNumber,
                                          style:
